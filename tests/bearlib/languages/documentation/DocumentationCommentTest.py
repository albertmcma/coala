...
class PythonDocumentationCommentTest(unittest.TestCase):
    ...
    def test_python_default(self):
        ...
        docs = tuple(extract_documentation(data, language, docstyle))

        parsed_docs = []

        for doc in docs:
            parsed_docs.append(doc.parse())
    ...
    def check_docstring(self,
        ...
        self.assertIsInstance(expected,
                              list,
                              "docstring needs to be a list for this test.")
    ...
    def test_not_implemented(self):
        not_implemented = DocumentationComment("some docs",
                                               "nolang",
                                               "doxygen")
